...
repo_full = os.getenv("GITHUB_REPOSITORY", "AliceJump/ok-end-field-x-anylabeling-asset")

if "/" in repo_full:
    OWNER, REPO = repo_full.split("/", 1)
else:
    OWNER = "AliceJump"
    REPO = "ok-end-field-x-anylabeling-asset"
...
HEADERS = {
    ...
    "User-Agent": "ok-end-field-x-anylabeling-asset-download-stats",
}
